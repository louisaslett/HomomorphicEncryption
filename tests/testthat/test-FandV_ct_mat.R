...
test_that("Matrix binding", {
  ...
  expect_that(suppressWarnings(dec(keys$sk, rbind(ctM1, ctV2))), is_equivalent_to(suppressWarnings(rbind(mM1, mV2))))
  ...
  expect_that(suppressWarnings(dec(keys$sk, rbind(ctV1, ctM2))), is_equivalent_to(suppressWarnings(rbind(mV1, mM2))))
  ...
  expect_that(suppressWarnings(dec(keys$sk, rbind(ctS, ctV1, ctM2))), is_equivalent_to(suppressWarnings(rbind(mS, mV1, mM2))))
  # expect_that(dec(keys$sk, rbind(ctM2, ctS, ctV1)), gives_warning())# rbind(mM2, mS, mV1) # TODO: this should give a warning under latest R and does not
  expect_that(suppressWarnings(dec(keys$sk, rbind(ctM2, ctS, ctV1))), is_equivalent_to(suppressWarnings(rbind(mM2, mS, mV1))))
  ...
  expect_that(suppressWarnings(dec(keys$sk, cbind(ctM1, ctV2))), is_equivalent_to(suppressWarnings(cbind(mM1, mV2))))
  ...
  expect_that(suppressWarnings(dec(keys$sk, cbind(ctV1, ctM2))), is_equivalent_to(suppressWarnings(cbind(mV1, mM2))))
  ...
  expect_that(suppressWarnings(dec(keys$sk, cbind(ctS, ctV1, ctM2))), is_equivalent_to(suppressWarnings(cbind(mS, mV1, mM2))))
  # expect_that(dec(keys$sk, cbind(ctM2, ctS, ctV1)), gives_warning())# cbind(mM2, mS, mV1))  # TODO: this should give a warning under latest R and does not
  expect_that(suppressWarnings(dec(keys$sk, cbind(ctM2, ctS, ctV1))), is_equivalent_to(suppressWarnings(cbind(mM2, mS, mV1))))
})
